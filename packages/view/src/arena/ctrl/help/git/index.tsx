...
export default function Git() {
    return (
        <div className={s.Git}>
            ...
            <div className={s.aline}>安装 git: </div>
            <div
                className={[s.aline, s.link].join(' ')}
                onClick={() => {
            ...
            <div className={s.aline}>注册码云</div>
            <div
                className={[s.aline, s.link].join(' ')}
                onClick={() => {
            ...
            <div className={s.aline}>生成ssh key</div>
            <div
                className={[s.aline, s.link].join(' ')}
                onClick={() => {
                    ipc().send(
            ...
            <div className={s.aline}>日常使用是非常简单的, 只有两三个按钮, 点击就可以完成远程仓库的推送和拉取</div>
            <div className={s.aline}></div>
        </div>
    )
}
