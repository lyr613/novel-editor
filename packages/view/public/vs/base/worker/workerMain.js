                ...
                i = (function() {
                    ...
                    return (
                        ...
                        (t.prototype._createAndWriteCachedData = function(e, t, n, r) {
                            var i = this,
                                o = Math.ceil(
                                    r.getConfig().getOptionsLiteral().nodeCachedData.writeDelay * (1 + Math.random()),
                                ),
                                s = -1,
                                u = 0,
                                a = void 0,
                    ...
                    return (
                        ...
                        (e._getElements = function(t) {
                            ...
                            if (e._isStringArray(n)) {
                                for (var i = new Int32Array(n.length), o = 0, s = n.length; o < s; o++)
                        ...
                        (e.prototype.ComputeRecursionPoint = function(e, t, r, i, o, u, a) {
                            ...
                            for (var L = 1; L <= m / 2 + 1; L++) {
                                ...
                                for (var w = d; w <= f; w += 2) {
                                    c =
                                        (l = w === d || (w < f && v[w - 1] < v[w + 1]) ? v[w + 1] : v[w - 1] + 1) -
                                        (w - y) -
                                        C
                                ...
                                for (w = h; w <= p; w += 2) {
                                    c =
                                        (l = w === h || (w < p && _[w - 1] >= _[w + 1]) ? _[w + 1] - 1 : _[w - 1]) -
                                        (w - b) -
                                        E
                ...
                c = (function() {
                    function e(e) {
                        ;(this._disposed = !1),
                            (this._options = e),
                            (this._leakageMon =
                                u > 0 ? new l(this._options && this._options.leakWarningThreshold) : void 0)
                    }
                    return (
            ...
            var d = (function(e) {
                ...
                return (
                    ...
                    (t.prototype.fire = function(t) {
                        this._listeners &&
                            (0 !== this._isPaused ? this._eventQueue.push(t) : e.prototype.fire.call(this, t))
                    }),
                    t
                )
            })(c)
                    ...
                    return (
                            ...
                            for (var u = [], a = 0, c = 0, h = ((i = -1), t.length); i < h; i++) {
                                for (
                                    ...
                                    if (v !== _) {
                                        ...
                                        ;(y > 1 || b > 1) &&
                                            this._pushTrimWhitespaceCharChange(u, a + 1, 1, y, c + 1, 1, b)
                                        for (
                                            var C = f(v, 1), E = f(_, 1), S = v.length + 1, L = _.length + 1;
                                            C < S && E < L;
                                        ...
                                        ;(C < S || E < L) &&
                                            this._pushTrimWhitespaceCharChange(u, a + 1, C, S, c + 1, E, L)
                                    }
                                    a++, c++
                                }
                                p &&
                        ...
                        (e.prototype._pushTrimWhitespaceCharChange = function(e, t, n, r, i, o, s) {
                            if (!this._mergeTrimWhitespaceCharChange(e, t, n, r, i, o, s)) {
                                var u = void 0
                                this.shouldComputeCharChanges && (u = [new a(t, n, t, r, i, o, i, s)]),
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }),
                ...
                (function(e) {
                    ;(e[(e.acceptSuggestionOnCommitCharacter = 0)] = 'acceptSuggestionOnCommitCharacter'),
                        ...
                        (e[(e.copyWithSyntaxHighlighting = 15)] = 'copyWithSyntaxHighlighting'),
                        (e[(e.cursorBlinking = 16)] = 'cursorBlinking'),
                        (e[(e.cursorSmoothCaretAnimation = 17)] = 'cursorSmoothCaretAnimation'),
                        (e[(e.cursorStyle = 18)] = 'cursorStyle'),
                        (e[(e.cursorSurroundingLines = 19)] = 'cursorSurroundingLines'),
                        (e[(e.cursorSurroundingLinesStyle = 20)] = 'cursorSurroundingLinesStyle'),
                        (e[(e.cursorWidth = 21)] = 'cursorWidth'),
                        (e[(e.disableLayerHinting = 22)] = 'disableLayerHinting'),
                        (e[(e.disableMonospaceOptimizations = 23)] = 'disableMonospaceOptimizations'),
                        ...
                        (e[(e.hideCursorInOverviewRuler = 42)] = 'hideCursorInOverviewRuler'),
                        (e[(e.highlightActiveIndentGuide = 43)] = 'highlightActiveIndentGuide'),
                        (e[(e.hover = 44)] = 'hover'),
                        ...
                        (e[(e.mouseWheelScrollSensitivity = 56)] = 'mouseWheelScrollSensitivity'),
                        (e[(e.mouseWheelZoom = 57)] = 'mouseWheelZoom'),
                        (e[(e.multiCursorMergeOverlapping = 58)] = 'multiCursorMergeOverlapping'),
                        ...
                        (e[(e.renderValidationDecorations = 73)] = 'renderValidationDecorations'),
                        (e[(e.renderWhitespace = 74)] = 'renderWhitespace'),
                        (e[(e.revealHorizontalRightPadding = 75)] = 'revealHorizontalRightPadding'),
                        ...
                        (e[(e.suggestOnTriggerCharacters = 92)] = 'suggestOnTriggerCharacters'),
                        ...
                        (e[(e.wordWrapBreakAfterCharacters = 98)] = 'wordWrapBreakAfterCharacters'),
                        (e[(e.wordWrapBreakBeforeCharacters = 99)] = 'wordWrapBreakBeforeCharacters'),
                ...
                return (
                    ...
                    (e.prototype.getIndexOf = function(e) {
                        ...
                        for (var t = 0, n = this.values.length - 1, i = 0, o = 0, s = 0; t <= n; )
                            if (((i = (t + (n - t) / 2) | 0), e < (s = (o = this.prefixSum[i]) - this.values[i])))
                                n = i - 1
                            else {
                                if (!(e >= o)) break
                                t = i + 1
                    ...
                    (t.prototype.computeWordRanges = function(e, t, n, r) {
                        return l(this, void 0, void 0, function() {
                            ...
                            return c(this, function(c) {
                                ...
                                for (
                                    o = new RegExp(n, r), s = Object.create(null), u = t.startLineNumber;
                                    u < t.endLineNumber;
                                    u++
                                )
